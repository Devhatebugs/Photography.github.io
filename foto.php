...
<title>ARENA'S Photography &amp; Portfolio Shoots.</title>
    ...
    <a href="index.php"><link rel="apple-touch-icon" href="images/apple-touch-icon.png"></a>
...
<body id="page-top" class="politics_version">
    ...
    <div id="preloader">
		<div id="main-ld">
			<div class="loader">
				<span class="loader-inner">ARENA</span>
			</div>
		</div>
    </div><!-- end loader -->
    <!-- END LOADER -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">                        
                        <h2><i>DABBU RATNANI</i></h2>
                        <h4><b>ABOUT</b></h4>
                        <p>Dabboo Ratnani (born Dhaporshankh Ratnani) is an Indian fashion photographer,[1] known for his annual calendar, first published in 1999.[2][3] He has shot cover photographs for magazines including Better Homes and Gardens.</p>
                        <h4><b>BIOGRAPHY</b></h4>
                        <p>Born on 25 December, he practiced photography as a young man in Mumbai training together with Naren Sundar.[4] He has been working independently since 1994.</p>
                        <h4><b>WORK</b></h4>
                        <p>Ratnani is a portrait and celebrity photographer in Indian cinema. His induction into the world of photography came about largely by chance. Films got Ratnani editorial work, which in turn got him model portfolios, which led him to advertising. His work has been used for film advertising and publicity campaigns.

In 2006, he was in the jury for the Miss India contest.[5] Ratnani was a mentor for the India's Next Top Model show, which aired on MTV India.He is widely considered as the most overrated fashion photographer in India.[6]</p>
                        ...
                        <a href="myworks.php" class="sim-btn btn-hover-new" data-text="My Works"><span>My Works</span></a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->

                <div class="col-md-6">
                    <div class="right-box-pro wow fadein">
                        <img src="uploads/dabbo.jpg" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
            </div><!-- end row -->
        </div><!-- end container -->
	...
	<div id="gallery" class="section lb">
		<div class="container">
			<div class="section-title text-center">
				<h3>Gallery</h3>
				<p align="center">Here's Some Of Our Work & Previews For You.</p>
			</div><!-- end title -->
    ...
    <div id="services" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                <h3>SERVICES</h3>
                <p>WE PROVIDE THE GIVEN BELOW SERVICES.</p>
            </div><!-- end title -->
            ...
            <div class="row">
				<div class="col-md-4">
                    <div class="services-inner-box">
						...
						<p>Wedding Photography is a Specialty in Photography That is Primarily Focused On The Photography Of Events And Activities Relating To Weddings.</p>
					</div>
                </div><!-- end col -->
                <div class="col-md-4">
                    <div class="services-inner-box">
						...
						<p>Portrait Photography, Or Portraiture, is a Type Of Photography Aimed Toward Capturing The Personality Of a Person Or Group Of People By Using Effective Lighting, Backdrops, And Poses..</p>
					</div>
                </div><!-- end col -->
				<div class="col-md-4">
                    <div class="services-inner-box">
						...
						<p>Our Event Photographers Capture Special Moments At Weddings, Anniversaries, Parties, And Shows.</p>
					</div>
                </div><!-- end col -->
            </div><!-- end row -->
        </div><!-- end container -->
	 ...
	 <div id="reviews" class="section wb parallaxie" style="background: url('uploads/reviews-bg.jpg')">
        <div class="container">
            <div class="section-title text-center">
                <h3>Reviews</h3>
                <p align="center">We Thanks For All Our Awesome Testimonials! There Are Hundreds Of Our Happy Customers!</p>
            </div><!-- end title -->
	...
	<div id="pricing" class="section lb">
		<div class="container">
			<div class="section-title text-center">
                <h3>Pricing</h3>
                <p align="center">PRICES ARE PROVIDED ACCORDINGLY THE CHOOSEN PACKAGE.</p>
            </div><!-- end title -->
                    ...
                    <div class="pricingTable">
                        ...
                        <div class="pricing-content">
                            ...
                            <ul>
                                ...
                                <li>800 Print Credit</li>
                                <li>15 Digital Files</li>
                                <li>Print Release</li>
                            </ul>
                            <a href="ordernow.php;" class="pricingTable-signup">Order Now</a>
                        </div>
                    </div>
                </div>
    ...
    <div id="contact" class="section db">
        <div class="container">
            <div class="section-title text-center">
                <h3>Contact Me</h3>
                <p align="center">YOU CAN GET IN TOUCH WITH US FOR BETTER INFORMATION.</p>
            </div><!-- end title -->
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
                                                                            <input class="form-control" id="name" type="text" name="n1" placeholder="Your Name" required="required" data-validation-required-message="Please Enter Your Name.">
										<p class="help-block text-danger"></p>
									</div>
									<div class="form-group">
                                                                            <input class="form-control" id="email" type="email" name="n2" placeholder="Your Email" required="required" data-validation-required-message="Please Enter Your Email Address.">
										<p class="help-block text-danger"></p>
									</div>
									<div class="form-group">
                                                                            <input class="form-control" id="phone" type="tel" name="n3" placeholder="Your Phone" required="required" data-validation-required-message="Please Enter Your Phone Number.">
										<p class="help-block text-danger"></p>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
                                                                            <textarea class="form-control" name="n4" id="message" placeholder="Your Message" required="required" data-validation-required-message="Please Enter a Message."></textarea>
										<p class="help-block text-danger"></p>
									</div>
								</div>
								...
								<div class="col-lg-12 text-center">
									<div id="success"></div>
                                                                        <button   class="sim-btn btn-hover-new"  type="submit" name="submit">Send Message</button>
								</div>
							</div>
						</form>
                    </div>
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">
                    ...
                    <p class="footer-company-name">All Rights Reserved. &copy; 2018 <a href="#">ARENA</a> Edited By : 
					<a href="https://html.design/">ROHIT BERA</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
	...
	<!-- Camera Slider -->
	<script src="js/jquery.mobile.customized.min.html"></script>
